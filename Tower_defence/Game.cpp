        ...
        switch (event.type) {
            ...
            case sf::Event::MouseButtonPressed:
                if (PauseButton.isMouseOver(window ) ){
                    ...
                    previewTower = std::make_unique<PelletTower>(sf::Vector2f(
                        0, 0));  // Position will be updated on hover
                    ...
                    currentState = GameState::PlacingTower;
                    previewTower = std::make_unique<SwarmTower>(sf::Vector2f(
                        0, 0));  // Adjust the class name as necessary
                    ...
                    currentState = GameState::PlacingTower;
                    previewTower = std::make_unique<DartTower>(sf::Vector2f(
                        0, 0));  // Adjust the class name as necessary
                    ...
                    currentState = GameState::PlacingTower;
                    previewTower = std::make_unique<SquirtTower>(sf::Vector2f(
                        0, 0));  // Adjust the class name as necessary
                    ...
                    currentState = GameState::PlacingTower;
                    previewTower = std::make_unique<BashTower>(sf::Vector2f(
                        0, 0));  // Adjust the class name as necessary
                    ...
                    currentState = GameState::PlacingTower;
                    previewTower = std::make_unique<FrostTower>(sf::Vector2f(
                        0, 0));  // Adjust the class name as necessary
